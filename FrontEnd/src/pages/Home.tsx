...
const Home = () => {
  ...
  const faqs = [
    {
      ...
      answer: "You may not be able to recover it. Please keep it safe.",
    },
    {
      question: "Is GiftChain custodial?",
      answer: "No, it's non-custodial. You control your assets.",
    },
    {
      question: "What tokens are supported?",
      answer: "We support ETH, USDC, DAI, and more.",
    },
  ];
  ...
  const imgIcon = [
    ...
    { title: "Lisk", icon: lisk },
    { title: "Usdc", icon: usdc },
    { title: "ChainLink", icon: chain },
    { title: "Btc", icon: btc },
  ];
  ...
  const chainList = [
    {
      icon: mark,
      title:
        "Select crypto type, gift amount, and recipient (email or wallet address).",
    },
    {
      icon: mark,
      title:
        "A unique redeemable code is created, which can be used by the recipient.",
    },
    {
      icon: mark,
      title:
        "Options for gift expiration and secure, blockchain-based transactions.",
    },
    {
      icon: mark,
      title:
        "The sender confirms, and the recipient redeems the code or receives crypto.",
    },
  ];
  ...
  return (
    <div className="bg-[#1F1668]">
        ...
        <div className="flex justify-center items-center gap-5">
          <div className="">
            <h2 className="text-3xl font-bold text-white">
              Give Old Fashioned Give the Gift of Crypto without the <br />{" "}
              Complexity No Wallet Address Needed.
            </h2>
            <p className="text-white">
              GiftChain lets you send crypto as easily as a message simple,
              secure, and personal.
            </p>
            <div className="flex mt-10 gap-3">
              <Button
                title="Create Gift Card"
                className="bg-[#9812C2] text-white"
                path="/create-gift"
              />
              <Button
      ...
      <Container className="">
        <h2 className="text-2xl mb-10 text-white font-bold text-center">
          Why GiftChain
        </h2>
          ...
          <div className="w-full p-[2px] rounded-3xl bg-gradient-to-r from-[#FFFFFF33] via-[#ff5911] to-[#ff4d00]">
            <div className="flex flex-col bg-white rounded-3xl p-4">
              ...
              <p className="text-[14px]">
                The easiest way to send crypto as a gift
              </p>
            </div>
          </div>
          <div className="w-full p-[2px] rounded-3xl bg-gradient-to-r from-[#FFFFFF33] via-[#ff5911] to-[#ff4d00]">
            <div className="flex flex-col bg-white rounded-3xl p-4">
              <img src={check} alt="" className="w-5 mb-2" />
              <p className="text-[14px]">
                Give crypto with meaning , no wallet address needed
              </p>
            </div>
          </div>
          <div className="w-full p-[2px] rounded-3xl bg-gradient-to-r from-[#FFFFFF33] via-[#ff5911] to-[#ff4d00]">
